            ...
            <div className="flex justify-between items-start max-lg:flex-col flex-wrap gap-20">
                <div className="flex flex-col items-start">
                    ...
                    <p className="mt-6 text-base text-white-400 leading-7 font-montserrat sm:max-w-sm">
                        ...
                        elit. Ipsa ipsum quibusdam labore nihil deleniti
                        corrupti ipsam voluptatum odit at vitae. Ipsa quasi
                        rerum recusandae ducimus?
                    </p>
                            ...
                            <div key={section}>
                                ...
                                <ul>
                                    {section.links.map((link) => (
                                        <li
                                            key={link.name}
                                            className="text-white-400 mt-3 leading-normal font-montserrat text-base hover:text-slate-gray cursor-pointer"
                                        >
                                            <a>{link.name}</a>
                                        </li>
                                    ))}
